...
import com.shollmann.android.fogon.interfaces.PageIndicator;

public class ImagesPageIndicator extends View implements PageIndicator {
    ...
    public ImagesPageIndicator(Context context) {
        this(context, null);
    }

    public ImagesPageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.vpiCirclePageIndicatorStyle);
    }

    public ImagesPageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPaintStroke.setColor(a.getColor(R.styleable.CirclePageIndicator_strokeColor, R.color.light_gray));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int iLoop = 0; iLoop < count; iLoop++) {
            ...
            if (pageFillRadius != mRadius) {
                rec.set(dX, dY, dX + (mRadius * 5), dY + mRadius);
